...
from gui.FRAMEWORK_SCREEN import FRAMEWORK_SCREEN
...
class PROPOSED_FRAMEWORKS_SCREEN(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        # Τίτλος
        ctk.CTkLabel(self, text="Προτεινομενα Πλαίσια", font=(
    ...
    def render_frame_list(self):
        ...
        if not filtered:
            ctk.CTkLabel(self.list_container, text="Δεν βρέθηκαν προτεινόμενα πλαίσια.",
        ...
        for frame_data in filtered:
            frame_row = ctk.CTkFrame(
                self.list_container, fg_color="#1e293b", corner_radius=8)
    ...
    def displayProposedFramework(self, frame_data):
        ...
        try:
            ...
            if "id" in frame_data:
                ...
                details = self.frame_manager.searchProposedFrameDetails(
                    framework_id)
                if details:
                    frame_data = details
